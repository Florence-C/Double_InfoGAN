...
# Initialize generator and discriminator
    ...
    elif args['discriminator']['model'] == 'DCGAN_double': 
        from .D_DCGAN_double import Discriminator
    else:
        raise NotImplementedError('Discriminator Model [%s] is not found' % args['discriminator']['model'])

    if args['generator']['model'] == 'DCGAN_Up': 
        from .G_DCGAN_Up import Generator
    elif args['generator']['model'] == 'DCGAN': 
    ...
    elif args['cr']['model'] == 'DCGAN_2': 
        from .CR_DCGAN_2 import CR_Net
    else:
