...
class Discriminator(nn.Module):
    def __init__(self, args):
        ...
        self.class_conv = nn.Conv2d(ndf * 8, 1, 4, 1, 0, bias=False)

        self.z_conv = nn.Conv2d(ndf * 8, args['background_latent_size'], 4, 1, 0, bias=False)

        self.s_conv = nn.Conv2d(ndf * 8, args['salient_latent_size'], 4, 1, 0, bias=False)
    ...
    def forward(self, input):
        ...
        adv = self.conv5(self.GaussNoise(out))
