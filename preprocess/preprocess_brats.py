...
def load_brats(dataset_folder="../../Data/brats_2021_2D", modality='t1'):
    ...
    print(total_labels_eval)

    print(total_labels_train.shape)

    np.save("brats_" + modality + "_img_train.npy", img_train)
    np.save("brats_" + modality + "_labels_train.npy", total_labels_train)

    np.save("brats_" + modality + "_img_eval.npy", img_eval)
    np.save("brats_" + modality + "_labels_eval.npy", total_labels_eval)
